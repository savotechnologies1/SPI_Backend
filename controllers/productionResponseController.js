...
//       scheudleDate: job.order_date,
//     }));
//  const totalQty = nextJob.scheduleQuantity || nextJob.quantity || 0;
//     const isBrandNewJob = nextJob.remainingQty === totalQty;
...
//     // Agar job fresh hai toh session null rakhein
//     const activeProduction = (!isBrandNewJob && currentSession) ? currentSession : null;
//     // --- TIMER RESET LOGIC (Fix: Only fetch active, non-scrapped session) ---
//     // const currentSession = await prisma.productionResponse.findFirst({
//     //   where: {
//     //     processId: processId,
...
//         incomingJobs: incomingJobs,
//         // cycleTime: lastProduction?.cycleTimeStart || null, // Reset Timer yahan se hoga
//           cycleTime: activeProduction?.cycleTimeStart || 0, 
//       },
//     });
//   } catch (error) {
//     return res
...
//     // 1. Pehle wo parts nikalo jinki training user ne "COMPLETE" kar li hai
//     const completedTrainings = await prisma.productionResponse.findMany({
//       where: {
//         stationUserId,
//         processId,
//         type: "training",
//         traniningStatus: true, // Jo complete ho chuki hain
//         isDeleted: false,
//       },
//       select: { partId: true },
//     });

//     const completedPartIds = completedTrainings.map((t) => t.partId);

//     // 2. Wo job dhundo jiska partId 'completedPartIds' list mein nahi hai
//     const nextJob = await prisma.stockOrderSchedule.findFirst({
//       where: {
//         processId,
//         isDeleted: false,
...
//           {
//             OR: [
//               { part_id: { notIn: completedPartIds } },
//               { customPartId: { notIn: completedPartIds } },
//             ],
//           },
//         ],
//       },
...
//     // Agar koi job nahi bacha, matlab training khatam!
//     if (!nextJob) {
//       return res.status(200).json({
//         allCompleted: true,
//         message: "All trainings completed for this station.",
//       });
//     }

//     const currentPartId = nextJob.part_id || nextJob.customPartId;

//     // 3. Find or Create Training Session (In-progress wala)
//     let production = await prisma.productionResponse.findFirst({
//       where: {
//         stationUserId,
//         processId,
//         partId: currentPartId,
//         type: "training",
//         traniningStatus: false, // Abhi jo chal raha hai
//         isDeleted: false,
//       },
//     });
